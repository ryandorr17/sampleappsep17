...
class CluesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clue" do
    assert_difference('Clue.count') do
      post clues_url, params: { clue: { activity: @clue.activity, answer: @clue.answer, clue: @clue.clue, location: @clue.location, picture: @clue.picture, stop: @clue.stop } }
    end
  ...
  test "should update clue" do
    patch clue_url(@clue), params: { clue: { activity: @clue.activity, answer: @clue.answer, clue: @clue.clue, location: @clue.location, picture: @clue.picture, stop: @clue.stop } }
